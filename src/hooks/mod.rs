//! Windows Run-key autostart management for crest.
//!
//! Ported from wiri's `src/hooks/startup.rs`.  The registry value name is
//! "crest" so it lives alongside (and does not collide with) wiri's entry.
